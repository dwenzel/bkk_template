...
class Tx_Modernpackage_Hooks_T3libBefunc {
	...
	protected function updateFlexforms(array &$dataStructure, array $row) {
		$dataStructure['sheets']['sDEF']['ROOT']['el']['acctables_tableclass']['TCEforms']['config'] = array(
			'type' => 'select',
			'items' => array(
				array('LLL:EXT:bkk_template/Resources/Private/Language/locallang_be.xml:tableclasses.default', 'table'),
				array('LLL:EXT:bkk_template/Resources/Private/Language/locallang_be.xml:tableclasses.striped', 'table table-striped'),
				array('LLL:EXT:bkk_template/Resources/Private/Language/locallang_be.xml:tableclasses.condensed', 'table table-condensed'),
			),
			'size' => 1,
			'maxitems' => 1,
		);
