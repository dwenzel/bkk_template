...
lib.extensions.indexed_search.form {
	...
	20 {
		...
		value (
			...
			<input name="tx_indexedsearch[sword]" type="text" class="search-query" placeholder="{LLL:EXT:bkk_template/Resources/Private/Language/locallang.xml:search-placeholder}">
				<button class="btn btn-mini">{LLL:EXT:bkk_template/Resources/Private/Language/locallang.xml:search-submit}</button>
			</form>
		)
	}
}
