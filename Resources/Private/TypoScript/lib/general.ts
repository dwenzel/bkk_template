...
lib.copyright_information {
	...
	10 {
		data = date:U
		strftime = %Y
		noTrimWrap = || {LLL:EXT:bkk_template/Resources/Private/Language/locallang.xml:copyright}|
...
lib.general.logo {
	10 = IMAGE
	10 {
		file = EXT:bkk_template/Resources/Public/Template/img/logo.png
...
lib.footer_logo {
	...
	10 = IMAGE
	10 {
		file = EXT:bkk_template/Resources/Public/Template/img/logo-government-package-footer.png
	}
}
